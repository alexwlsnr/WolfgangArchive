	...
	var BaseHref=(window.location != window.parent.location) ? document.referrer: document.location; // "" for internal use
...
Menu1=new Array("Jump to","","",3,18,60,"","","","","","",-1,-1,-1,"","");
		...
		Menu1_2=new Array("Golden Sun 2","javascript:top.document.location.href='../gs2-web/index.html'","",0,18,80,"","","","","","",-1,-1,-1,"",""); //  ../gs2-web/index.html for internal use
Menu1_3=new Array("Main Menu","javascript:top.document.location.href='../choose.htm'","",0,18,80,"","","","","","",-1,-1,-1,"",""); //  ../choose.htm for internal use 
